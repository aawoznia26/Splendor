...
public class Cards1LevelRepository {
    ...
    private Cards1Level _3black_3w_3b_5g_3rCard = new Cards1Level(_3black_3w_3b_5g_3rCost, Colors.BLACK, _3black_3w_3b_5g_3r, 3 );
    private Cards1Level _3blue__3w_3g_3r_5bcCard = new Cards1Level(_3blue__3w_3g_3r_5bcCost, Colors.BLUE, _3blue__3w_3g_3r_5bc, 3 );
    private Cards1Level _3green_5w_3b_3r_3bcCard = new Cards1Level(_3green_5w_3b_3r_3bcCost, Colors.GREEN, _3green_5w_3b_3r_3bc, 3 );
    private Cards1Level _3red_3w_5b_3g_3bcCard = new Cards1Level(_3red_3w_5b_3g_3bcCost, Colors.RED, _3red_3w_5b_3g_3bc, 3 );
    private Cards1Level _3white_3b_3g_5r_3bcCard = new Cards1Level(_3white_3b_3g_5r_3bcCost, Colors.WHITE, _3white_3b_3g_5r_3bc, 3 );
    private Cards1Level _4black_3g_6r_3bcCard = new Cards1Level(_4black_3g_6r_3bcCost, Colors.BLACK, _4black_3g_6r_3bc, 4 );
    private Cards1Level _4black_7rCard = new Cards1Level(_4black_7rCost, Colors.BLACK, _4black_7r, 4 );
    ...
    public Cards1Level get_3black_3w_3b_5g_3rCard() {
        return _3black_3w_3b_5g_3rCard;
    }

    public Cards1Level get_3blue__3w_3g_3r_5bcCard() {
        return _3blue__3w_3g_3r_5bcCard;
    }

    public Cards1Level get_3green_5w_3b_3r_3bcCard() {
        return _3green_5w_3b_3r_3bcCard;
    }

    public Cards1Level get_3red_3w_5b_3g_3bcCard() {
        return _3red_3w_5b_3g_3bcCard;
    }

    public Cards1Level get_3white_3b_3g_5r_3bcCard() {
        return _3white_3b_3g_5r_3bcCard;
    }

    public Cards1Level get_4black_3g_6r_3bcCard() {
        return _4black_3g_6r_3bcCard;
    }

    public Cards1Level get_4black_7rCard() {
    ...
    public boolean takeCard(Player player, Cards1Level card, int position) {
