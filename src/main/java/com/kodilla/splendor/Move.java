...
public class Move {
    ...
    public boolean commitMove() {
        ...
        if (cardTaken > 1 || aristocratsTaken > 1) {
            System.out.println("You can take only one card and one aristocrat within move. Try again.");
            ifCommited = false;
        } else if (cardTaken == 1 && (diamondTaken + sapphireTaken + onyxTaken + emeraldTaken + rubyTaken) > 0) {
            System.out.println("You can either take card or jewels within move. Try again.");
            ifCommited = false;
        } else if ((diamondTaken + sapphireTaken + onyxTaken + emeraldTaken + rubyTaken) > 3) {
            System.out.println("You can either take 2 jewel of the same kind or 3 jewel from different kinds within move. Try again.");
            ifCommited = false;
            ...
            System.out.println("You can either take 2 jewel of the same kind or 3 jewel from different kinds within move. Take more.");
            ifCommited = false;
        } else {
            ifCommited = true;
        }
